...
public class Frame implements IFrame
{
    ...
    private IMenuInvoker menuI = new MenuOption() ;
   ...
   /**
    ...
    public Frame(IScreen initial)
    {
        ...
        portraitStrategy = new IOrientationStrategy() 
        {
            ...
            /** Select Command F */
            public void selectF() { menuF.invoke() ; }
            
            /** Select Command G */
            public void selectG() { menuG.invoke() ; }
            
            /** Select Command H */
            public void selectH() { menuH.invoke() ; }
            
            /** Select Command I */
            public void selectI() { menuI.invoke() ; }
     ...
     * @param slot A, B,C,D,E,F,G,H,I,J,K
    ...
    public void setMenuItem( String slot, IMenuCommand c )
    {
        ...
        if ( "F".equals(slot) ) { menuF.setCommand(c) ; }  
        if ( "G".equals(slot) ) { menuG.setCommand(c) ; }  
        if ( "H".equals(slot) ) { menuH.setCommand(c) ; }
        if ( "I".equals(slot) ) { menuI.setCommand(c) ; } 
    }
    ...
    public void cmd( String c ) 
    {
        ...
        if ( "F".equals(c) ) { selectF() ; }  
        if ( "G".equals(c) ) { selectG() ; }  
        if ( "H".equals(c) ) { selectH() ; }
        if ( "I".equals(c) ) { selectI() ; } 
    }
    ...
    /** Select Command F */
    public void selectF() { currentStrategy.selectF() ;  }  
    
    /** Select Command G */
    public void selectG() { currentStrategy.selectG() ;  }  
    
    /** Select Command H */
    public void selectH() { currentStrategy.selectH() ;  } 
    
    /** Select Command I */
    public void selectI() { currentStrategy.selectI() ;  }
